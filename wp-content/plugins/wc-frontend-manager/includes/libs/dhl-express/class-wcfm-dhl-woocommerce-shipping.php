...
class wf_dhl_woocommerce_shipping_method extends WC_Shipping_Method {
    ...
    public function validate_box_packing_field($key) {
        $boxes_id           = isset($_POST['boxes_id']) ? wc_clean($_POST['boxes_id']) : array();
        $boxes_name         = isset($_POST['boxes_name']) ? wc_clean($_POST['boxes_name']) : array();
        
        $boxes_length       = isset($_POST['boxes_length']) ? wc_clean($_POST['boxes_length']) : array();
        $boxes_width        = isset($_POST['boxes_width']) ? wc_clean($_POST['boxes_width']) : array();
        $boxes_height       = isset($_POST['boxes_height']) ? wc_clean($_POST['boxes_height']) : array();
        $boxes_inner_length = isset($_POST['boxes_inner_length']) ? wc_clean($_POST['boxes_inner_length']) : array();
        $boxes_inner_width  = isset($_POST['boxes_inner_width']) ? wc_clean($_POST['boxes_inner_width']) : array();
        $boxes_inner_height = isset($_POST['boxes_inner_height']) ? wc_clean($_POST['boxes_inner_height']) : array();
        
        $boxes_box_weight   = isset($_POST['boxes_box_weight']) ? wc_clean($_POST['boxes_box_weight']) : array();
        $boxes_max_weight   = isset($_POST['boxes_max_weight']) ? wc_clean($_POST['boxes_max_weight']) : array();
        $boxes_enabled      = isset($_POST['boxes_enabled']) ? wc_clean($_POST['boxes_enabled']) : array();
        $boxes_pack_type    = isset($_POST['boxes_pack_type']) ? wc_clean($_POST['boxes_pack_type']) : array();
    ...
    public function validate_services_field($key) {
        $services = array();
        $posted_services = wc_clean($_POST['dhl_service']);
